            ...
            )
{
    ...
    return EXECUTE_SUCCESS;//end of for
}//end of function
            ...
            )
{
    ...
    //Write the a data into the file
...
//   Description   : It is use to read the data from file
    ...
    while(1) //conditional loop // 1-indicates True
    {
        ...
        else if(iCount == 2)
        {
            ...
            if(strcmp("unlink",Command[0]) == 0)
            {
                ...
                {
                    printf(" Execute the filedata succcessfully\n");
                }
        ...
        else if(iCount == 3)
        {
            ...
            if(strcmp("read",Command[0])==0)
            {
                ...
                {
                    printf("Error : There is no sufficient data\n");
                }
                else
                {
