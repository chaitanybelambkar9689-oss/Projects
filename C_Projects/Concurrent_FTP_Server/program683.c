...
int main(int argc, char *argv[])
{
    ...
    socklen_t AddrLen = sizeof(ClientAddr);  //address lemngth thevanyasathi socklen_t  ha data type use kartat
    ...
    while(1)
    {
        ...
        printf("Client gets connected : %s\n",inet_ntoa(ClientAddr.sin_addr));  // inet_ntoa == IP address la number format madhun string fot madhe convert kart
