...
The library is designed to support clean OOP principles, modularity, and extensibility—
making it suitable for both academic learning and real-world application development.
